...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Status", "狀態"),
        ("Access Control", "訪問控制"),
        ("Access Permissions", "訪問權限"),
        ("access_permissions_tip", "管理用戶端能否被允許的操作和權限。"),
        ("Permission scheme", "權限方案"),
        ("Advanced Permissions", "進階權限"),
        ("Expand", "展開"),
        ("Collapse", "收起"),
        ("Access Credentials", "訪問權限"),
        ("Access Password", "訪問密碼"),
        ("access_password_tip", "管理遠端連線與訪問驗證方式。"),
        ("Access mode", "訪問方式"),
        ("One-time password", "一次性密碼"),
        ("Enable one-time password", "啟用一次性密碼"),
        ("Password length", "密碼長度"),
        ("Use numeric", "使用數字"),
        ("Permanent password", "固定密碼"),
        ("Enable permanent password", "啟用固定密碼"),
        ("connection_protection_tip", "設定工作階段與裝置的連線保護選項。"),
        ("Connection Protection", "連接保護"),
        ("Your Desktop", "您的桌面"),
        ("Local ID", "本機ID"),
        ("local_id_tip", "您的本機ID，分享給他人後他們即可遠端連線到您"),
        ("one_time_password_tip", "一次性密碼，可點擊重新整理按鈕重新產生"),
        ("desk_tip", "您可以透過此 ID 及密碼存取您的桌面"),
        ("Password", "密碼"),
        ("Ready", "就緒"),
        ("Established", "已建立"),
        ("connecting_status", "正在連線到 LinkEase 網路..."),
        ("Enable service", "啟用服務"),
        ("Start service", "啟動服務"),
        ...
        ("Transfer file", "傳輸檔案"),
        ("Connect", "連線"),
        ("Recent sessions", "近期連接"),
        ("Search device or ID", "搜尋裝置或ID"),
        ("All time", "全部時間"),
        ("Today", "今天"),
        ("This week", "本週"),
        ("This month", "本月"),
        ...
        ("Use IP Whitelisting", "只允許白名單 IP 訪問"),
        ("Network", "網路"),
        ("Pin Toolbar", "釘選工具列"),
        ...
        ("Elevate", "提升權限"),
        ("Zoom cursor", "縮放游標"),
        ("Accept sessions via password", "允許密碼驗證後訪問"),
        ...
        ("Smoothness priority", "流暢優先"),
        ("img_quality_best_sub", "提供更高的畫面清晰度"),
        ("img_quality_balanced_sub", "在清晰度和流暢度之間取得平衡"),
        ...
        ("adv_individual_windows_sub", "將每個螢幕作為獨立視窗開啟"),
        ("adv_all_displays_sub", "使用本機的全部螢幕進行工作階段"),
        ("adv_show_monitors_sub", "在遠端工具列中顯示多螢幕切換"),
        ("advanced_features_tip", "提升遠端體驗的進階選項"),
        ("Input enhancement", "輸入增強"),
        ("Session and privacy", "工作階段與隱私"),
        ("Window and toolbar", "視窗與工具列"),
        ("Display and performance", "顯示與效能"),
        ("Network and performance", "網路與效能"),
        ("Experimental features", "實驗功能"),
        ("Screen sharing mode", "螢幕共享模式"),
        ("Open displays in a single window", "在單一視窗中開啟螢幕"),
        ("Enable UDP connection", "啟用UDP協定連線"),
        ("Enable IPv6 connection", "啟用IPv6 P2P連線"),
        ("adv_screen_share_sub", "控制共享的螢幕內容。"),
        ("adv_privacy_mode_sub", "隱藏遠端裝置背景與資訊。"),
        ("adv_collapse_toolbar_sub", "自動摺疊工具列以擴大檢視。"),
        ("adv_lock_after_sub", "結束工作階段後自動鎖定裝置。"),
        ("adv_reverse_wheel_sub", "反轉滑鼠滾輪方向。"),
        ("adv_swap_mouse_sub", "交換滑鼠左右鍵功能。"),
        ("adv_quality_monitor_sub", "即時監測連線品質。"),
        ("adv_single_window_sub", "所有螢幕合併到一個視窗。"),
        ("adv_udp_sub", "使用UDP協定連線。"),
        ("adv_ipv6_sub", "透過IPv6進行P2P直連。"),
        ("adv_mute_sub", "預設靜音遠端裝置的音訊"),
        ("adv_true_color_sub", "以更高色彩精度（4:4:4）顯示畫面"),
        ("hwcodec_advanced_tip", "啟用硬體編解碼加速以提升效能。"),
        ("adaptive_bitrate_tip", "根據網路狀況自動調整位元速率。"),
        ("directx_capture_tip", "使用 DirectX 擷取螢幕以提升效能。"),
        ("confirm_close_tabs_tip", "關閉多個分頁前進行確認。"),
        ("open_new_tab_tip", "在新分頁中開啟連線。"),
        ("remove_wallpaper_tip", "被控時暫時移除桌面桌布。"),
        ("auto_update_tip", "自動下載並安裝新版本。"),
        ("keep_awake_tip", "發起工作階段期間保持本機喚醒。"),
        ("linux_headless_tip", "允許無顯示器的 Linux 主機被控。"),
        ("Bitrate", "位元速率"),
        ("FPS", "FPS"),
        ("Auto", "自動"),
        ...
        ("{} sessions", "{} 個工作階段"),
        ("scam_title", "請確認對方的身分。"),
        ("scam_text1", "如果對方不是佳影寰球科技有限公司的工作人員，卻要求你使用 LinkEase 啟動服務，請勿繼續操作並立刻掛斷。"),
        ...
        ("allow-only-conn-window-open-tip", "僅當 LinkEase 視窗開啟時才允許連線"),
        ...
        ("Enable UDP hole punching", "啟用 UDP 協議"),
        ("View camera", "檢視相機"),
        ...
        ("verify_rustdesk_password_tip", "請輸入 LinkEase工具 驗證密碼"),
        ("Remote Control", "遠端協助"),
        ("Input text", "隨便說點什麼吧"),
        ("Ready to start", "我準備好了"),
        ("Update your account password", "修改帳號密碼"),
        ("Sign out of your account", "退出登入"),
        ("Online", "線上"),
        ("Offline", "離線"),
        ("Releases", "發布頁"),
        ("Common", "通用"),
        ("Phone Number", "手機號碼"),
        ("No user info", "暫無使用者資訊"),
        ("Go to Download", "前往下載"),
        ("Releases", "發布頁"),
        ("Download different versions of LinkEase", "下載不同版本的 LinkEase 工具"),
        ("User Edition", "使用者版 LinkEase 工具"),
        ("Tools for regular users", "面向一般使用者的工具"),
        ("Support Edition", "客服版 LinkEase 工具"),
        ("Dedicated tools for support staff", "面向客服人員的專屬工具"),
        ("Remote Control Tagline", "Remote Control · 遠端控制工具"),
        ("Terms of Service", "使用者服務協議"),
        ("Copyright Notice", "© 2026 佳影寰球科技有限公司 版權所有\n基於Rustdesk開源專案建構，詳見使用者服務協議"),
        ("account_abnormal_title", "帳號異常"),
        ("account_kicked_message", "帳號已在其他裝置登入"),
        ("btn_exit_directly", "直接退出"),
        ("btn_relogin", "重新登入"),
        ("remote_disabled_title", "遠端功能已停用"),
        ("remote_disabled_message", "遠端功能已被管理員停用，遠端連線已中斷。\n管理員恢復權限後將自動恢復。"),
        ("register_title", "註冊帳號"),
        ("field_confirm_password", "確認密碼"),
        ("field_activation_code", "啟用碼"),
        ("get_sms_code", "取得驗證碼"),
        ("register_btn", "註 冊"),
        ("please_enter_username", "請輸入使用者名稱"),
        ("account_input_hint", "請輸入帳戶.."),
        ("account_password_empty", "帳號和密碼不能為空"),
        ("username_format_tip", "使用者名稱需為1-20位字元，只能包含英文、數字和底線"),
        ("password_format_tip", "密碼需為6-20位字元，且包含字母和數字"),
        ("password_length_tip", "密碼需為6-20位字元"),
        ("password_letter_digit_tip", "密碼需包含字母和數字"),
        ("password_not_match", "兩次密碼輸入不一致"),
        ("please_enter_phone", "請輸入手機號碼"),
        ("phone_must_be_11_digits", "手機號碼必須為11位數字"),
        ("please_enter_sms_code", "請輸入驗證碼"),
        ("please_enter_valid_characters", "請輸入規範的字元"),
        ...
        ("go_to_login", "去登入"),
        ("terms_agreed_prefix", "我已閱讀並同意"),
        ("terms_link_label", "《使用者協議》"),
        ("and_connector", "與"),
        ("privacy_link_label", "《隱私政策》"),
        ("activation_code_expired_title", "啟用碼已失效"),
        ("please_enter_new_activation_code", "請輸入新的啟用碼繼續使用"),
        ("new_activation_code_label", "新啟用碼"),
        ("activation_code_expired_error", "啟用碼已過期"),
        ("password_reset_success", "密碼已重置，請使用新密碼登入"),
        ("tab_account_login", "帳號登入"),
        ("tab_phone_login", "手機登入"),
        ("no_account_prompt", "沒有帳號？"),
        ("register_now", "立即註冊"),
        ("remember_password", "記住密碼（7天）"),
        ("login_btn", "登 入"),
        ...
        ("confirm_change_btn", "確認修改"),
        ("change_pwd_failed", "修改密碼失敗"),
        ...
        ("btn_confirm", "確定"),
        ("app_title", "LinkEase遠端操控"),
        ("register_failed", "註冊失敗"),
        ("login_failed", "登入失敗"),
        ("send_failed", "發送失敗"),
        ("reset_failed", "重置失敗"),
        ("network_error", "網路錯誤"),
        ("server_wrong_credentials", "使用者名稱或密碼錯誤"),
        ("server_wrong_password", "密碼錯誤"),
        ("server_user_not_found", "使用者不存在"),
        ("server_username_exists", "使用者名稱已存在"),
        ("server_phone_registered", "手機號碼已註冊"),
        ("server_wrong_sms_code", "驗證碼錯誤"),
        ("server_sms_code_expired", "驗證碼已過期"),
        ("server_sms_too_frequent", "驗證碼發送過於頻繁"),
        ("server_invalid_activation_code", "啟用碼無效"),
        ("server_activation_code_used", "啟用碼已被使用"),
        ("server_account_disabled", "帳號已被停用"),
        ("server_invalid_phone_format", "手機號碼格式錯誤"),
        ("server_invalid_params", "參數錯誤"),
        ("server_internal_error", "伺服器內部錯誤"),
        ("server_rate_limited", "請求過於頻繁，請稍後再試"),
        ...
        ("No devices", "暫無裝置"),
        ("Device list refreshed", "裝置列表已重新整理"),
        ("Unknown", "未知"),
        ...
        ("Deregister account", "註銷賬號"),
        ("Edit profile", "編輯資料"),
        ("Forgot Password", "忘記密碼"),
        ("acc_change_pwd_sub", "定期更改密碼，保護賬戶安全"),
        ...
        ("change_phone_title", "更換手機號"),
        ("acc_change_phone_sub", "更換賬號綁定的手機號"),
        ("current_phone_label", "目前手機號"),
        ("new_phone_number", "新手機號"),
        ("phone_unchanged", "新手機號不能與目前的相同"),
        ("change_phone_success", "手機號修改成功"),
        ("change_phone_failed", "手機號修改失敗"),
        ("change_phone_warning", "驗證碼將傳送至新手機號，更換後請使用新手機號進行簡訊登入。"),
