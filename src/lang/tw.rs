...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("{} sessions", "{} 個工作階段"),
        ("scam_title", "請確認對方的身分。"),
        ("scam_text1", "如果對方不是佳影寰球科技有限公司的工作人員，卻要求你使用 Gamwing 啟動服務，請勿繼續操作並立刻掛斷。"),
        ...
        ("verify_rustdesk_password_tip", "請輸入 Gamwing工具 驗證密碼"),
        ("Remote Control", "遠端協助"),
        ("Input text", "隨便說點什麼吧"),
        ...
        ("Go to Download", "前往下載"),
        ("Releases", "發布頁"),
        ("Download different versions of Gamwing", "下載不同版本的 Gamwing 工具"),
        ("User Edition", "使用者版 Gamwing 工具"),
