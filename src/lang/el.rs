...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("{} sessions", "{} συνεδρίες"),
        ("scam_title", "Παρακαλούμε επιβεβαιώστε την ταυτότητα του άλλου μέρους."),
        ("scam_text1", "Εάν το άλλο μέρος δεν είναι προσωπικό της Gamwing Global Technology Co., Ltd. και σας ζητήσει να χρησιμοποιήσετε το Gamwing και να ξεκινήσετε την υπηρεσία, μην συνεχίσετε και κλείστε αμέσως."),
