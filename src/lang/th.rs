...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("{} sessions", "{} เซสชัน"),
        ("scam_title", "โปรดตรวจสอบตัวตนของอีกฝ่าย"),
        ("scam_text1", "หากอีกฝ่ายไม่ใช่เจ้าหน้าที่ของ Gamwing Global Technology Co., Ltd. และขอให้คุณใช้ Gamwing และเริ่มบริการ โปรดอย่าดำเนินการต่อและวางสายทันที"),
