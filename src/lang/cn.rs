...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("deregister_warning", "注销后账户及所有数据将被永久删除且无法恢复，请谨慎操作。"),
        ("confirm_deregister", "确认注销"),
        ("deregister_success", "账号已注销"),
        ("deregister_phone_mismatch", "手机号与当前账号不匹配"),
        ("current_username_label", "当前用户名"),
        ("new_username_label", "新用户名"),
        ("username_rule_tip", "用户名需为 1-20 位字符，只能包含英文和数字"),
        ("verify_identity_password", "请输入登录密码以验证身份"),
        ("username_unchanged", "新用户名不能与当前用户名相同"),
        ("change_username_success", "用户名修改成功"),
        ("change_username_failed", "用户名修改失败"),
        ("change_phone_title", "更换手机号"),
        ("acc_change_phone_sub", "更换账号绑定的手机号"),
        ("current_phone_label", "当前手机号"),
        ("new_phone_number", "新手机号"),
        ("phone_unchanged", "新手机号不能与当前手机号相同"),
        ("change_phone_success", "手机号修改成功"),
        ("change_phone_failed", "手机号修改失败"),
        ("change_phone_warning", "验证码将发送至新手机号，更换后请使用新手机号进行短信登录。"),
        ("No user info", "暂无用户信息"),
        ...
        ("restore_defaults_tip", "这将把本页所有高级功能重置为默认值，是否继续？"),
        ...
        ("confirm-clear-shortcuts-inhibitor-permission-tip", "是否确认重置键盘快捷键权限？"),
        ("Reset keyboard shortcuts permission", "重置键盘快捷键权限"),
        ("clear-shortcuts-inhibitor-permission-tip", "重置后，下次需要时将再次提示您授予键盘快捷键权限。"),
        ...
        ("confirm_change_btn", "确认修改"),
        ("change_pwd_failed", "修改密码失败"),
        ...
        ("server_activation_code_disabled", "激活码已被禁用"),
        ...
        ("All", "全部"),
        ("Keep your software up to date", "保持软件更新！"),
    ].iter().cloned().collect();
}
