...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("advanced_features_tip", "启用或调整高级与实验性功能"),
        ("Account Info", "账户信息"),
        ...
        ("adv_collapse_toolbar_sub", "默认折叠远程会话的工具栏"),
        ("adv_reverse_wheel_sub", "反转鼠标滚轮的滚动方向"),
        ("adv_swap_mouse_sub", "交换鼠标左右键的功能"),
        ("adv_view_mode_sub", "默认以仅查看模式建立连接"),
        ("adv_show_cursor_sub", "在远程屏幕上显示远程设备的鼠标光标。"),
        ("adv_quality_monitor_sub", "显示连接质量的实时监测信息"),
        ("adv_mute_sub", "默认静音远程设备的音频"),
        ("adv_file_copy_sub", "允许在会话中复制粘贴文件"),
        ("adv_disable_clipboard_sub", "默认禁用剪贴板内容同步"),
        ("adv_lock_after_sub", "会话结束后自动锁定远程电脑"),
        ("adv_privacy_mode_sub", "连接时开启隐私模式（远端黑屏）"),
