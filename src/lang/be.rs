...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("{} sessions", "{} сеансаў"),
        ("scam_title", "Калі ласка, праверце асобу суразмоўцы."),
        ("scam_text1", "Калі суразмоўца не з'яўляецца супрацоўнікам Gamwing і просіць вас выкарыстоўваць Gamwing і запусціць сэрвіс, не працягвайце і адразу спыніце размову."),
        ("scam_text2", "Магчыма, гэта аферыст, які паспрабуе ўкрасці вашыя грошы або іншую асабістую інфармацыю."),
