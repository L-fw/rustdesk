...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("{} sessions", "{} sessions"),
        ("scam_title", "Veuillez vérifier l'identité de l'autre partie."),
        ("scam_text1", "Si l'autre partie n'appartient pas au personnel de Gamwing Global Technology Co., Ltd. et vous demande d'utiliser Gamwing et de démarrer le service, ne continuez pas et raccrochez immédiatement."),
