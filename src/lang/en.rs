...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("username_rule_tip", "Username must be 1-20 characters: letters and digits only"),
        ("verify_identity_password", "Enter your login password to verify"),
        ("username_unchanged", "The new username must be different from the current one"),
        ...
        ("acc_change_phone_sub", "Update the phone number bound to your account"),
        ("current_phone_label", "Current phone number"),
        ("new_phone_number", "New phone number"),
        ("phone_unchanged", "The new phone number must be different from the current one"),
        ("change_phone_success", "Phone number updated"),
        ("change_phone_failed", "Failed to change phone number"),
        ("change_phone_warning", "The verification code will be sent to the new phone number. After the change, use the new number for SMS login."),
        ...
        ("account_password_empty", "Account and password cannot be empty"),
