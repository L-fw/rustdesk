...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Due to UAC, Gamwing can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install Gamwing to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant Gamwing \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant Gamwing \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Gamwing to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Gamwing Input] service."),
        ...
        ("doc_mac_permission", "https://Gamwing.com/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next Gamwing application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant Gamwing \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant Gamwing \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Gamwing."),
        ...
        ("verify_Gamwing_password_tip", "Verify Gamwing password"),
        ...
        ("scam_text1", "If the other party is not Gamwing Global Technology Co., Ltd. staff and asks you to use Gamwing and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_Gamwing_server_pro_to_{}_tip", "Please upgrade Gamwing Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://Gamwing.com/docs/en/client/linux/#x11-required"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent Gamwing from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by Gamwing"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if Gamwing window is open"),
        ...
        ("floating_window_tip", "It helps to keep Gamwing background service"),
        ...
        ("upgrade_remote_Gamwing_client_to_{}_tip", "Please upgrade the Gamwing client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, Gamwing verifies the server certificate for protocols using TLS.\nWith this option enabled, Gamwing will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, Gamwing will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: Gamwing server OSS doesn't include this feature."),
        ...
        ("verify_rustdesk_password_tip", "Please enter the Gamwing Tools verification password"),
        ...
        ("Releases", "Releases"),
        ("Download different versions of Gamwing", "Download different versions of Gamwing Tools"),
        ("User Edition", "User Edition of Gamwing Tools"),
        ("Tools for regular users", "Tools designed for regular users"),
        ("Support Edition", "Support Edition of Gamwing Tools"),
        ...
        ("Terms of Service", "Terms of Service"),
        ("Copyright Notice", "© 2026 Gamwing Global Technology Co., Ltd. All rights reserved.\nBuilt on the RustDesk open-source project. See Terms of Service for details."),
